...
<div class="input_group">
  <SizeInputs units={['px']} showOptionTypes={false} optionValue={size || ''} onChange={value => updateSize(value)} />

  <select value={style || ''} on:change={e => updateStyle(e.currentTarget.value)}>
    <option>solid</option>
  ...
  <ColorPicker {color} onChange={value => updateColor(value)} />
</div>
